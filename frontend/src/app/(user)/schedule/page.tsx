...
import { BookMarked, FlagTriangleRight, User } from "lucide-react";

export default async function SchedulePage(){
    return (
        <div className="grid  lg:grid-cols-10  xl:grid-cols-8 lg:gap-4 space-y-4 lg:space-y-0">
